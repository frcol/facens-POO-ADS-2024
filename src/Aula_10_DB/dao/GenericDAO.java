package Aula_10_DB.dao;

import Aula_10_DB.util.IgnoreInDAO;
...
/*
    ...
    6- Atributos da Entity precisa ter os mesmos campos da Tabela
        ex: Entity Produto: id, nome, quantidade, valorUnitario
            tabela: id (PK, AI), nome, quantidade, valorUnitario 
*/
public abstract class GenericDAO<T> {
    ...
    // ex:
    // Animal ani = new AnimalDAO().getByField(Animal.class, "nome", "Xodo");
    // Animal ani = new AnimalDAO().getByField(Animal.class, "id", 1);
